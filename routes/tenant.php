...
Route::group(['middleware'=>['web', InitializeTenancyByDomain::class,PreventAccessFromCentralDomains::class] ], function () {
        ...
        Route::get('migrate', '\App\Http\Controllers\landlord\LandingPageController@migrateDB');
        Route::get('renew-subscription', '\App\Http\Controllers\landlord\ClientController@renewSubscription');
        Route::get('change-permission', '\App\Http\Controllers\landlord\ClientController@changePermission');
        Route::get('switch-package', '\App\Http\Controllers\landlord\ClientController@switchPackage');
        Route::get('reset-db', '\App\Http\Controllers\landlord\ClientController@resetDB');
