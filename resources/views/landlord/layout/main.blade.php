    ...
    <div id="loader"></div>
      ...
      <nav class="side-navbar">
        <span class="brand-big">
            ...
            <a href="{{url('/')}}"><img src="{{url('landlord/images/logo', $general_setting->site_logo)}}" width="115"></a>
            @else
        ...
        <ul id="side-main-menu" class="side-menu list-unstyled">
            ...
            <li><a target="_blank" href="{{route('landlordDocumentation')}}"> <i class="dripicons-information"></i><span>{{trans('file.Documentation')}}</span></a></li>
            @endif
        </ul>
      </nav>
