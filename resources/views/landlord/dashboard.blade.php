...
@if (env('USER_VERIFIED'))
    <div id="alertSection" class="{{ $versionUpgradeData['alert_version_upgrade_enable']==true ? null : 'd-none' }} alert not-slide alert-primary alert-dismissible fade show" role="alert">
