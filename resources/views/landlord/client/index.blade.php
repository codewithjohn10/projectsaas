                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <button type="button" data-id="{{$client->id}}" class="add-custom-domain-btn btn btn-link" data-toggle="modal" data-target="#customDomainModal" ><i class="dripicons-plus"></i>  {{trans('file.Add Custom Domain')}}</button>
                                </li>
...
<!-- custom domain Modal -->
<div id="customDomainModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
          ...
          <form>
            <div class="row">
                <div class="col-md-6 form-group">
                    ...
                    <input type="text" name="domain" required class="form-control" placeholder="example.com">
